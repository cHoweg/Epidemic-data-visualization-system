...
public class JavaDemo {
    ...
    //配置您申请的KEY
    public static final String APICODE ="4321b569bf5d485793b09bd80cd1c79b";
 ...
 //           System.out.println(arrayList);
            ...
            System.out.println(continent.getClass().toString());
            for(int i=0;i<continent.size();i++){
                Map o = (Map) continent.get(i);
                System.out.println(o);
                String continentName = (String)o.get("continentName");
                Double confirmedCount = (Double) o.get("confirmedCount");
                Double curedCount = (Double) o.get("curedCount");
                Double deadCount= (Double) o.get("deadCount");
                ArrayList country= (ArrayList) o.get("country");
                ...
                System.out.println(country.getClass().toString());
