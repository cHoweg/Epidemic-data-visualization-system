...
public class TravelHandler {
    public static String urlStr = "http://apis.juhe.cn/springTravel/query?key=2a045db4716657a67be6f8340405c6f8&from=10191&to=10349";
    ...
    public static void main(String[] args) {
        ...
        public static List<TravelBean> getData () {
